	...
	<div class="container /*content-md*/ mywrapper">
		<div class="row margin-bottom-60">
			...
			<div class="col-md-9">
				...
				<div ng-cloak>{{'page.policy.0' | i18next}}</div>
			</div>
	...
	<div class="parallaxBg twitter-block twitter-blockmyimg  margin-bottom-30" style="color: white">
		<div class="container">
			<div class="col-md-8">
				...
				<p style="color: white; font-size: 16px;" ng-cloak>{{'page.policy.2' | i18next}}</p>
			</div>
		</div>
	</div>
	<!--=== End Twitter-Block ===-->
	...
	<div class="container /*content-md*/">
		<div class="row margin-bottom-60">
			<div class="col-md-8">
				...
				<div style="text-align:left;" class="margin-bottom-60" ng-cloak>{{'page.policy.4' | i18next}}</div>
			
				<div class="heading /*heading-v1*/ margin-bottom-10">
					<h2 ng-cloak>{{'page.policy.successexec.title' | i18next}}</h2>
				</div>
				<div style="text-align:left;" ng-cloak>{{'page.policy.successexec.header' | i18next}}</div>
				<div style="text-align:left;" ng-cloak>{{'page.policy.successexec.list.title' | i18next}}</div>
				<ol style="text-align:left;">
					<li ng-cloak>{{'page.policy.successexec.list.0' | i18next}}</li>
					<li ng-cloak>{{'page.policy.successexec.list.1' | i18next}}</li>
					<li ng-cloak>{{'page.policy.successexec.list.2' | i18next}}</li>
					<li ng-cloak>{{'page.policy.successexec.list.3' | i18next}}</li>
					<li ng-cloak>{{'page.policy.successexec.list.4' | i18next}}</li>
				</ol>
			</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-12">
					...
					<div class="overflow-h">
						<p ng-cloak>{{'page.policy.principle.0' | i18next}}</p>
						<p ng-cloak>{{'page.policy.principle.1' | i18next}}</p>
						<p ng-cloak>{{'page.policy.principle.2' | i18next}}</p>
					</div>
				</div>
			</div>
		</div>
	...
	<div class="container /*content-md*/">
		<div class="row margin-bottom-60">
			...
			<div class="col-md-8">
				...
				<div class="margin-bottom-15" ng-cloak>{{'page.policy.staffmanage.0' | i18next}}</div>
				<div class="margin-bottom-15" ng-cloak>{{'page.policy.staffmanage.1' | i18next}}</div>
				<div class="margin-bottom-15" ng-cloak>{{'page.policy.staffmanage.2' | i18next}}</div>
			</div>
		</div>
		...
		<div class="row margin-bottom-30">
			<div class="col-md-8">
				...
				<div class="margin-bottom-15" ng-cloak>{{'page.policy.impgoal.0' | i18next}}</div>
				<div class="margin-bottom-15" ng-cloak>{{'page.policy.impgoal.1' | i18next}}</div>
