	...
	<div class="container /*content-md*/">
		...
		<div class="row margin-bottom-60">
			<div class="col-lg-8 col-md-8 col-sm-8">
				...
				<div style="text-align:left;" class="margin-bottom-15" ng-cloak>
				...
				<div class="margin-bottom-15" ng-cloak>
				...
				function initMap() {
  	            ...
  	            function fid_140052407543525456224(ymaps) {
  	                ...
  	                map.geoObjects
  	                    .add(new ymaps.Placemark(['57.223349', '50.270122'], {
  	                        balloonContent: ""
  	                    }, {
